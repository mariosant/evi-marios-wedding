...
var save_the_date = {
    ...
    setCountDown: function () {
        ...
        var n = 'σε <span id="days"></span> ' + e.option.labels[0] + ',  <span id="hours"></span> ' + e.option.labels[1] + ',  <span id="minutes"></span> ' + e.option.labels[2] + " και" + '  <span id="seconds"></span> ' + e.option.labels[3];
        $("#timer").html(n)
    },
